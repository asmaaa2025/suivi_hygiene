...
class _CleaningHistoryPageState extends State<CleaningHistoryPage> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (mounted) {
        debugPrint(
          '[CleaningHistory] Updating UI with ${nettoyages.length} nettoyages',
        );
        setState(() {
          ...
          Expanded(
            child: _isLoading
                ...
                ? const EmptyState(
                    ...
                    message:
                        'Vous n\'avez pas encore d\'historique de nettoyage',
                    icon: Icons.history,
                  )
                : RefreshIndicator(
                    onRefresh: _loadData,
