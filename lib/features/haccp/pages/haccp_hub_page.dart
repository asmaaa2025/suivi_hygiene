  ...
  Future<void> _exportModule(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            'Registre PDF créé. Utilisez Partager pour l\'envoyer (format contrôle officiel).',
          ),
              ...
              Expanded(
                child: Align(
                  ...
                  child: GridView.count(
                    ...
                    mainAxisSpacing: 10,
                    childAspectRatio:
                        1.4, // Increased to make cubes less tall (wider relative to height)
                    shrinkWrap: true,
                        ...
                        actions: [
                          ...
                          ModuleAction(
                            ...
                            onTap: () => _exportModule(context, [
                              HaccpExportService.kTemperatures,
                            ]),
                          ),
                        ],
                      ),
                      ...
                      ModuleCubeWithMenu(
                        ...
                        actions: [
                          ...
                          ModuleAction(
                            ...
                            icon: Icons.download,
                            onTap: () => _exportModule(context, [
                              HaccpExportService.kReceptions,
                            ]),
                          ),
                        ],
                      ),
                      ...
                      ModuleCubeWithMenu(
                        ...
                        actions: [
                          ModuleAction(
                            ...
                            icon: Icons.add,
                            onTap: () =>
                                context.go('$prefix/cleaning/taches/new'),
                          ),
                          ModuleAction(
                            label: 'Historique',
                            icon: Icons.history,
                      ...
                      ModuleCubeWithMenu(
                        ...
                        actions: [
                          ...
                          ModuleAction(
                            ...
                            icon: Icons.no_food,
                            onTap: () =>
                                context.go('$prefix/tableau-allergenes'),
                          ),
                          ModuleAction(
                            label: 'Exporter',
                            icon: Icons.download,
                      ...
                      ModuleCubeWithMenu(
                        ...
                        actions: [
                          ...
                          ModuleAction(
                            ...
                            icon: Icons.history,
                            onTap: () =>
                                context.go('$prefix/alerts/nc/history'),
                          ),
                          ModuleAction(
                      ...
                      ModuleCubeWithMenu(
                        ...
                        actions: [
                          ...
                          ModuleAction(
                            ...
                            onTap: () =>
                                context.go('$prefix/synthese-hebdomadaire'),
                          ),
                        ],
                      ),
                    ],
