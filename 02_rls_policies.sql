...
-- Users can update organizations they created (simplified)
...
-- EMPLOYEES POLICIES
-- ============================================
-- Users can read employees they created (simplified to avoid recursion)
...
-- SUPPLIERS POLICIES
-- ============================================
-- Users can read their own suppliers (simplified to avoid recursion)
...
-- AUDIT_LOG POLICIES
-- ============================================
-- Users can read audit logs where they are the actor (simplified to avoid recursion)
CREATE POLICY "audit_log_select_policy" ON public.audit_log
  FOR SELECT USING (
    actor_user_id = auth.uid() OR
    actor_employee_id IN (
